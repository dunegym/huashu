...
- **公式**：
  $$\text{mel-opic ELR}_{\text{test}} = \frac{E_{\text{mel}}}{E_v}$$
- **说明**：
  - $\text{mel-opic ELR}$（efficacy of luminous radiation）：mel-opic 辐照度与照度的比值，单位为 $\text{W/m}^2/\text{lux}$。
...
- **计算 D65 的 mel-opic ELR**：
  $$\text{mel-opic ELR}_{\text{D65}} = \frac{E_{\text{mel, D65}}}{E_{v, \text{D65}}}$$

#### **6. 计算 mel-DER**
- **公式**：
  $$\text{mel-DER} = \frac{\text{mel-opic ELR}_{\text{test}}}{\text{mel-opic ELR}_{\text{D65}}}$$
- **说明**：
